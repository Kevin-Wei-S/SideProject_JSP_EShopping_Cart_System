          ...
          <table>
              ...
              <c:forEach items="${ requestScope.page.items }" var="foodStuff">
              	...
              	<tr>
              		...
              		<td><a href="http://localhost:8080/BM02/manager/foodStuffServlet?action=getFoodStuff&id=${ foodStuff.id }&page=${ requestScope.page.pageNo }" class="update">更改</a></td>
              		<td><a href="http://localhost:8080/BM02/manager/foodStuffServlet?action=delete&id=${ foodStuff.id }&page=${ requestScope.page.pageNo }" class="delete">刪除</a></td>	
              	</tr>
